...
config['ledger-consensus-continuity'].merge.fixedDebounce = 0;
config['ledger-consensus-continuity'].operations.debounce = 0;
config['ledger-consensus-continuity'].writer.debounce = 0;
